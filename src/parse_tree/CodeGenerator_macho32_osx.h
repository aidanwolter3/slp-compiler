#ifndef CODE_GENERATOR_MACHO32_OSX
#define CODE_GENERATOR_MACHO32_OSX
...
class CodeGenerator_macho32_osx : public Visitor {
  private:
  ...
  public:
    CodeGenerator_macho32_osx(SymbolTable *symbolTable, char *output);
    void write_exit();
    void print_code();
    void write_code();
